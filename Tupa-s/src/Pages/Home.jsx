        ...
        <>
            <div className="min-h-screen bg-Fundo bg-cover">
                ...
                <div className="Servicos" ref={el}>
                    <div className=" flex flex-col md:flex-row gap-20 p-10 justify-around items-center ">
            ...
            <div className="bg-color_bg bg-opacity-75 ">
                <h1 className="text-4xl text-color text-color_vinho font-bold p-20 ml-4  flex justify-center ">
                    Compras no APP
                </h1>
