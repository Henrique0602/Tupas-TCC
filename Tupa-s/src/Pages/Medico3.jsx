        ...
        <>
            ...
            <div className="p-10  min-h-screen">
                <div className="mt-5 mb-5  p-6 rounded-lg ">
                    <h1 className="font-bold text-2xl mb-4">Conheça mais um pouco sobre a Dr. Fulano:</h1>
                    <p className=" mb-4">
                    ...
                    <div className="flex justify-between mb-5">
                        <img className="rounded-3xl shadow-md w-52" src="https://evorastudio.com.br/wp-content/uploads/2021/03/fotos-para-medicos-1.jpg" alt="Dr. Fulano" />
                ...
                <div className="flex flex-col mt-10">
                    <h2 className="font-bold text-xl mb-5 p-6 ">Deixe um comentário para nosso Dr.</h2>
                    <textarea 
