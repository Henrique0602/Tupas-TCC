        ...
        <>
            ...
            <div className="p-10  min-h-screen">
                <div className="mt-5 mb-5  p-6 rounded-lg ">
                    <h1 className="font-bold text-2xl mb-4">Conheça mais um pouco sobre a Dr. Beltrana:</h1>
                    <p className=" mb-4">
                    ...
                    <div className="flex justify-between mb-5">
                        <img className="rounded-3xl shadow-md w-52" src="https://storage.alboom.ninja/sites/15118/albuns/1009779/fotografia_medicas_medicos_campinas_estudio_consultorio-2.jpg?t=1693321616" alt="Dr. Beltrana" />
