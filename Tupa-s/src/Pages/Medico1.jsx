        ...
        <>
            ...
            <div className="p-10  min-h-screen">
                <div className="mt-5 mb-5  p-6 rounded-lg ">
                    <h1 className="font-bold text-2xl mb-4">Conheça mais um pouco sobre a Dr. Ciclana:</h1>
                    <p className=" mb-4">
                    ...
                    <div className="flex justify-between mb-5">
                        <img className="rounded-3xl shadow-md w-52" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbce17idxswgkpW9QpFKbFTQ81RuavmyYE1H_O6D1-4e4Kf0LGGrwqCH0UNmwOGGJA7OQ&usqp=CAU" alt="Dr. Ciclana" />
