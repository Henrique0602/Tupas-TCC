import React from 'react';
  ...
  function Planos (){
    return (
      <div className="card-container bg-color_bg bg-opacity-75  shadow-md  ">
      <h1 className="text-2xl text-color text-color_vinho font-bold pt-10 mt-24 ml-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 p-10 justify-center items-center">
              {/* Gratis */}
              <div className="bg-color_vinho text-white rounded-lg shadow-lg p-10 flex flex-col justify-between skew-y-6 hover:scale-110 transition-transform duration-300 ease-in-out">
                  <div>
              ...
              {/* TRIMESTRAL */}
              <div className="bg-color_vinho text-white rounded-lg shadow-lg p-8 flex flex-col justify-between skew-y-6 hover:scale-110 transition-transform duration-300 ease-in-out ">
                  <div>
